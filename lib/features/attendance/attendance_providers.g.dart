...
String _$checkInSubmitterHash() => r'03f4d118dcf022039bc23ce34d3e4aacd0d7154e';
...
String _$monthlyAttendanceHash() => r'55d5d47643eea0a2c762f5f524208dba4ae12ca0';
...
class MonthlyAttendanceFamily extends Family<AsyncValue<MonthlyAttendanceDto>> {
  ...
  ///
  /// Copied from [monthlyAttendance].
  MonthlyAttendanceProvider call(int year, int month) {
    return MonthlyAttendanceProvider(year, month);
  }
...
class MonthlyAttendanceProvider
  ...
  ///
  /// Copied from [monthlyAttendance].
  MonthlyAttendanceProvider(int year, int month)
    : this._internal(
        (ref) => monthlyAttendance(ref as MonthlyAttendanceRef, year, month),
